...
const Map<String, String> kTr = {
  ...
  'support': 'Destek',
  'account': 'Hesap',
  'termsBody': 'Sarkis Bread\'i kullanarak, Berlin ve Hamburg teslimat bölgeleri içinde kapıda nakit ödemeyle sipariş vermeyi kabul edersiniz. Siparişler seçilen teslimat tarihine göre hazırlanır. Fiyatlar EUR cinsindedir ve değişebilir. Siparişinizle ilgili uygulama veya telefon yoluyla sizinle iletişime geçebiliriz.',
...
const Map<String, String> kHy = {
  ...
  'account': 'Հաշիվ',
  'termsBody': 'Օգտագործելով Sarkis Bread՝ դուք համաձայնում եք պատվիրել կանխիկ վճարմամբ առաքման ժամանակ Բեռլինի և Համբուրգի առաքման գոտիներում։ Պատվերները պատրաստվում են ըստ ընտրված առաքման ամսաթվի։ Գները նշված են եվրոյով և կարող են փոխվել։ Մենք կարող ենք կապվել ձեզ հետ ձեր պատվերի վերաբերյալ հավելվածի կամ հեռախոսի միջոցով։',
