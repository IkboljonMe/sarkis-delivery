/// Localized welcome message sent automatically from the admin (Sarko) to a
/// customer the first time they register. Falls back to English.
class WelcomeMessage {
  WelcomeMessage._();

  static const String senderName = 'Sarko';

  static String forLang(String lang) => _messages[lang] ?? _messages['en']!;

  static const Map<String, String> _messages = {
    'en':
        'Hi! 👋 I\'m Sarko, the admin of Sarko Delivery.\n\n'
    ...
    'ru':
        'Здравствуйте! 👋 Я Sarko, администратор Sarko Delivery.\n\n'
    ...
    'de':
        'Hallo! 👋 Ich bin Sarko, der Admin von Sarko Delivery.\n\n'
            ...
            'gerne. Guten Appetit! 🥖',
    'tr':
        'Merhaba! 👋 Ben Sarko, Sarko Delivery yöneticisiyim.\n\n'
            ...
            'olsun! 🥖',
    'hy':
        'Բարև! 👋 Ես Sarko-ն եմ՝ Sarko Delivery-ի ադմինը։\n\n'
