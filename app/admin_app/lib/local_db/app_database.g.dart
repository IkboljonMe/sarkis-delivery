...
class $LocalUserTable extends LocalUser
  ...
  List<GeneratedColumn> get $columns =>
      [id, role, email, name, lastName, updatedAt];
  @override
...
class LocalUserData extends DataClass implements Insertable<LocalUserData> {
  ...
  @override
  int get hashCode => Object.hash(id, role, email, name, lastName, updatedAt);
  @override
...
class $OrdersTable extends Orders with TableInfo<$OrdersTable, Order> {
  ...
  late final GeneratedColumn<String> userCity = GeneratedColumn<String>(
      ...
      requiredDuringInsert: false,
      defaultValue: const Constant(''));
  static const VerificationMeta _userGroupMeta =
      const VerificationMeta('userGroup');
  @override
  late final GeneratedColumn<String> userGroup = GeneratedColumn<String>(
      'user_group', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      defaultValue: const Constant(''));
  ...
  @override
  late final GeneratedColumn<bool> cashCollected = GeneratedColumn<bool>(
      'cash_collected', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: false,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'CHECK ("cash_collected" IN (0, 1))'),
      defaultValue: const Constant(false));
  ...
  Order map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Order(
      ...
      userGroup: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}user_group'])!,
      ...
      cashCollected: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}cash_collected'])!,
...
class Order extends DataClass implements Insertable<Order> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['user_group'] = Variable<String>(userGroup);
    ...
    map['cash_collected'] = Variable<bool>(cashCollected);
  ...
  factory Order.fromJson(Map<String, dynamic> json,
    ...
    return Order(
      ...
      userGroup: serializer.fromJson<String>(json['userGroup']),
      ...
      cashCollected: serializer.fromJson<bool>(json['cashCollected']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'userGroup': serializer.toJson<String>(userGroup),
      ...
      'cashCollected': serializer.toJson<bool>(cashCollected),
...
class OrdersCompanion extends UpdateCompanion<Order> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (userGroup.present) {
      map['user_group'] = Variable<String>(userGroup.value);
    }
    ...
    if (cashCollected.present) {
      map['cash_collected'] = Variable<bool>(cashCollected.value);
    }
...
class $ChatTopicsTable extends ChatTopics
  ...
  late final GeneratedColumn<bool> lastFromAdmin = GeneratedColumn<bool>(
      ...
      defaultValue: const Constant(false));
  static const VerificationMeta _adminUnreadMeta =
      const VerificationMeta('adminUnread');
  @override
  late final GeneratedColumn<int> adminUnread = GeneratedColumn<int>(
      'admin_unread', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      defaultValue: const Constant(0));
  @override
  ...
  VerificationContext validateIntegrity(Insertable<ChatTopic> instance,
    ...
    if (data.containsKey('admin_unread')) {
      context.handle(
          _adminUnreadMeta,
          adminUnread.isAcceptableOrUnknown(
              data['admin_unread']!, _adminUnreadMeta));
    }
    return context;
  }
  ...
  ChatTopic map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ChatTopic(
      ...
      adminUnread: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}admin_unread'])!,
    );
  }
...
class ChatTopic extends DataClass implements Insertable<ChatTopic> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['admin_unread'] = Variable<int>(adminUnread);
    return map;
  }
  ...
  factory ChatTopic.fromJson(Map<String, dynamic> json,
    ...
    return ChatTopic(
      ...
      adminUnread: serializer.fromJson<int>(json['adminUnread']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'adminUnread': serializer.toJson<int>(adminUnread),
    };
  }
  ...
  ChatTopic copyWithCompanion(ChatTopicsCompanion data) {
    return ChatTopic(
      ...
      lastFromAdmin: data.lastFromAdmin.present
          ...
          : this.lastFromAdmin,
      adminUnread:
          data.adminUnread.present ? data.adminUnread.value : this.adminUnread,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(
      id, userName, userGroup, lastMessage, lastAt, lastFromAdmin, adminUnread);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ChatTopic &&
          ...
          other.adminUnread == this.adminUnread);
}
...
class ChatTopicsCompanion extends UpdateCompanion<ChatTopic> {
  ...
  const ChatTopicsCompanion({
    ...
    this.adminUnread = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ...
  static Insertable<ChatTopic> custom({
    ...
    return RawValuesInsertable({
      ...
      if (adminUnread != null) 'admin_unread': adminUnread,
      if (rowid != null) 'rowid': rowid,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (adminUnread.present) {
      map['admin_unread'] = Variable<int>(adminUnread.value);
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
...
class $ApprovalsTable extends Approvals
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, type, userId, userName, changesJson, status, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Approval extends DataClass implements Insertable<Approval> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, type, userId, userName, changesJson, status, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Approval &&
...
class $$OrdersTableFilterComposer
  ...
  ColumnFilters<String> get userPhone => $composableBuilder(
      column: $table.userPhone, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<String> get userGroup => $composableBuilder(
      column: $table.userGroup, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<bool> get cashCollected => $composableBuilder(
...
class $$OrdersTableOrderingComposer
  ...
  ColumnOrderings<String> get userPhone => $composableBuilder(
      column: $table.userPhone, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get userGroup => $composableBuilder(
      column: $table.userGroup, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<bool> get cashCollected => $composableBuilder(
...
class $$OrdersTableAnnotationComposer
  ...
  GeneratedColumn<String> get userGroup =>
  ...
  GeneratedColumn<bool> get cashCollected => $composableBuilder(
  ...
  $$OrdersTableTableManager(_$AppDatabase db, $OrdersTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<String> userGroup = const Value.absent(),
            ...
            Value<bool> cashCollected = const Value.absent(),
...
class $$ChatTopicsTableFilterComposer
  ...
  ColumnFilters<int> get adminUnread => $composableBuilder(
      column: $table.adminUnread, builder: (column) => ColumnFilters(column));
}
...
class $$ChatTopicsTableOrderingComposer
  ...
  ColumnOrderings<int> get adminUnread => $composableBuilder(
      column: $table.adminUnread, builder: (column) => ColumnOrderings(column));
}
...
class $$ChatTopicsTableAnnotationComposer
  ...
  GeneratedColumn<int> get adminUnread => $composableBuilder(
      column: $table.adminUnread, builder: (column) => column);
}
  ...
  $$ChatTopicsTableTableManager(_$AppDatabase db, $ChatTopicsTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<int> adminUnread = const Value.absent(),
            Value<int> rowid = const Value.absent(),
          }) =>
              ChatTopicsCompanion(
            id: id,
