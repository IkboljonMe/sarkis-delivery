...
class ChatTopicModel {
  ...
  final int unread;
  // Status of the last message (for chat-list ticks; only meaningful when the
  // last message was sent by the admin).
  ...
  factory ChatTopicModel.fromJson(Map<String, dynamic> json) => ChatTopicModel(
        ...
        lastFromAdmin: json['lastFromAdmin'] as bool? ?? false,
        lastDelivered: true,
        lastRead: (json['customerUnread'] as num? ?? 0) == 0,
      );
}
