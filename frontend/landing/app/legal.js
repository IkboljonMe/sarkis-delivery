// Multilingual Privacy Policy & Terms content for Sarkis Delivery.
...
export const TERMS = {
  en: {
    ...
    sections: [
      { h: "1. Acceptance", p: "By using Sarkis Delivery you agree to these terms. Sarkis Delivery connects our old and new customers with fresh Armenian bread and related products, delivered to your door." },
  ...
  ru: {
    ...
    sections: [
      { h: "1. Принятие условий", p: "Используя Sarkis Delivery, вы соглашаетесь с этими условиями. Sarkis Delivery — это мост между нашими старыми и новыми клиентами: свежий армянский хлеб и сопутствующие товары с доставкой до двери." },
  ...
  de: {
    ...
    sections: [
      { h: "1. Zustimmung", p: "Mit der Nutzung von Sarkis Delivery stimmen Sie diesen Bedingungen zu. Sarkis Delivery verbindet unsere alten und neuen Kunden mit frischem armenischem Brot und zugehörigen Produkten, direkt an Ihre Tür geliefert." },
  ...
  tr: {
    ...
    sections: [
      { h: "1. Kabul", p: "Sarkis Delivery'i kullanarak bu koşulları kabul edersiniz. Sarkis Delivery, eski ve yeni müşterilerimizi taze Ermeni ekmeği ve ilgili ürünlerle kapınıza kadar teslimatla buluşturur." },
  ...
  hy: {
    ...
    sections: [
      { h: "1. Համաձայնություն", p: "Օգտագործելով Sarkis Delivery-ն՝ դուք համաձայնում եք այս պայմաններին։ Sarkis Delivery-ն կամուրջ է մեր հին և նոր հաճախորդների միջև՝ թարմ հայկական հաց և հարակից ապրանքներ առաքմամբ մինչև ձեր դուռ։" },
...
export const PRIVACY = {
  en: {
    ...
    sections: [
      ...
      { h: "3. Where it is stored", p: "Your data is stored securely in Google Firebase. Access is limited to the Sarkis Delivery team for the purposes above." },
  ...
  ru: {
    ...
    sections: [
      ...
      { h: "3. Где они хранятся", p: "Ваши данные надёжно хранятся в Google Firebase. Доступ ограничен командой Sarkis Delivery для указанных выше целей." },
  ...
  tr: {
    ...
    sections: [
      ...
      { h: "3. Nerede saklanıyor", p: "Verileriniz Google Firebase'de güvenle saklanır. Erişim, yukarıdaki amaçlar için Sarkis Delivery ekibiyle sınırlıdır." },
  ...
  hy: {
    ...
    sections: [
      ...
      { h: "3. Որտեղ են պահվում", p: "Ձեր տվյալները ապահով պահվում են Google Firebase-ում։ Հասանելիությունը սահմանափակված է Sarkis Delivery-ի թիմով՝ վերոնշյալ նպատակների համար։" },
